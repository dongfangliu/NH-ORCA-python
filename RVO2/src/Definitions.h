...
namespace RVO {
	 ...
	 */
	inline float distSqPointLineSegment(const Eigen::Vector2f &a, const Eigen::Vector2f &b,
	 ...
	 */
	inline float leftOf(const Eigen::Vector2f &a, const Eigen::Vector2f &b, const Eigen::Vector2f &c)
	{
		return det(a - c, b - a);
	}
