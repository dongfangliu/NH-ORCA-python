...
namespace RVO {
	...
	inline float abs(const Vector2 &vector)
	{
		...
		inline float abs(const Eigen::Vector2f &vector)
	{
		return vector.norm();
	}
	...
	inline float absSq(const Vector2 &vector)
	{
		...
		inline float absSq(const Eigen::Vector2f &vector)
	{
	...
	inline float det(const Eigen::Vector2f &vector1, const Eigen::Vector2f &vector2)
	{
		return vector1.x() * vector2.y() - vector1.y() * vector2.x();
	}
	/**
	...
	inline Eigen::Vector2f normalize(const Eigen::Vector2f &vector){
